...
-- Solving the first part of the MCQ Maji Ndogo Part 1 MCQ 
...
*
FROM md_water_services.employee
WHERE employee_name LIKE ('Vuyisile%');
...
-- Number 7 doesn't require me to run a query but i did anyways
SELECT 
* 
...
-- I skipped number 9 because i don't need to write a query
